    ...
    <main>
        ...
        <div style="margin: 50px 300px; box-shadow : 3px 3px 3px gray">
                <div style="padding : 20px 40px; background-color : white">
                    <center>
                        <h1 style="color: #0D67B5">Reservation Confirmation</h1>
                        ...
                        <form action="" method="">
                            ...
                            <div class="disp">
                                <div class="flex" style="width : 50%">
                                    <a href="reservation.html" class="btn" style="padding : 5px 25px;background-color : #8ABFEE; color : white; border-radius : 15px">Continue</a>
                                </div>
                                <div class="flex" style="width : 50%">
